...
\bild{0.6}{MVVM/mvvmschema.png}{Die Schichten des MVVM-Entwufsmusters}{mvvmA}
\ 
\newline
...
\bild{0.6}{MVVM/MVVM.png}{Die Schichten des MVVM-Entwufsmusters in Verbindung mit der WPF}{mvvm}
...
\bild{0.6}{MVVM/binding.png}{Schema des Binding des DataContext an Properties der Viewmodel}{datcont}
