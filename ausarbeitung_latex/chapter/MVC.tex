...
\end{center}
	...
	\subsection{Controller}
		...
		Es gibt keine Standarddefinition für MVC. Viele Frameworks benutzen unterschiedliche Versionen.\\
...
\begin{itemize}
	...
	\item{Besonders nützlich mit Web Interfaces. (bei GUI frameworkds eher weniger)}
\end{itemize}
